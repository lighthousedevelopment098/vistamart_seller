...
const ForgotPasswordViaPhone = () => {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${apiConfig.seller}/vendors/forgot-password-on-sms`,
  ...
  const handleOtpValidation = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${apiConfig.seller}/vendors/validate-otp`,
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${apiConfig.seller}/vendors/reset-password-on-sms`,
        { phone: fullPhoneNumber, otp, passwordNew: newPassword, passwordConfirm: confirmPassword }
      );
