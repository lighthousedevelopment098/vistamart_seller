      ...
      <div className="bg-white p-6 rounded shadow-md w-full max-w-md lg:max-w-lg">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="text-center mb-5">
            ...
            <span className="text-gray-500">(Seller Login)</span>
          </div>
...
// import { useNavigate } from "react-router-dom";
// import "react-toastify/dist/ReactToastify.css";
// import { login, selectAuthLoading, selectAuthError } from "../../components/redux/auth/authSlice";
